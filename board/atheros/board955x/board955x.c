...
//	ath_reg_rmw_set(GPIO_OE_ADDRESS, (1 << 13));
	...
	//[[Benson]MR900]: 2014/12/08 Benson re-mark, according to mr900 patch
...
//	ath_reg_rmw_set(GPIO_OE_ADDRESS, (1 << 12));
	...
	//[[Benson]MR900: Add] : 2014/12/08 Migrate from MR900 patch
		...
		case 1:
			switch (cmd) {
				case 0:
				{
					...
					//[[Benson]mr900]: 2014/12/08 remark and add
					//int i = -1;
					int led[] = {19, 21};
					int i = -1, j = 0;
					//[[Benson]mr900]: 2014/12/08
					...
					setenv (key, "no");
					//[[Benson]mr900]: 2014/12/08 re-mark and add
